...
comb_postop_covid.sub[is.na(`Adjusted Hazard Ratio for censoring 30 day readmissions`),`:=`(`Adjusted Hazard Ratio for censoring 30 day readmissions` = 1, `95% CI`= "Ref")]
comb_postop_covid.sub[is.na(`Adjusted Hazard Ratio for censoring 30 day mortality`),`:=`(`Adjusted Hazard Ratio for censoring 30 day mortality` = 1, `95% CI`= "Ref")]
