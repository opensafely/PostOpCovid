...
This plot shows the changing effect of post operative COVID infection on VTE risk in the initial, alpha, delta and omicron waves.
...
``` 
This plot shows the daily risk of VTE by post operative COVID infection for a a 50-70 year old female with a single morbidity with a bmi of 20, for an abdominal cancer operation, without previous COVID-19, with a booster vaccination, from the East Midlands in an area ranked in the 3rd quintile for deprivation. This showed the risk peaked in the first week after operation before falling to a level baseline.

```{r postopcovid_daily_VTE_tv}
...
```{r postopVTErecentcovid_sub, results='asis'}
...
```{r postopcovid_daily_sub_VTE_tv}
