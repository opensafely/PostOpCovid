...
demo.tab <- xtable::xtable(
  ...
  t(cbind(dt[is.finite(get(paste0(proc,'_date_admitted'))) ,.("Procedures" = rnd(.N),
                                 ...
                                 "90 day mortality" =n.perc(is.finite(date_death_ons) & date_death_ons - get(paste0(proc,'_date_admitted')) <= 90,dig = 4),
                                 "90 day COVID-19" = n.perc(is.finite(get(paste0(proc,'_date'))) & get(paste0(proc,'_date')) - get(paste0(proc,'_date_admitted')) <= 90  & get(paste0(proc,'_date')) - get(paste0(proc,'_date_admitted')) >=0,dig = 3),
                                 "90 day VTE" = n.perc(((is.finite(get(paste0(proc,"_VTE_HES_date_admitted"))) & get(paste0(proc,'_VTE_HES_date_admitted')) - get(paste0(proc,'_date_admitted')) <= 90  & get(paste0(proc,'_VTE_HES_date_admitted')) - get(paste0(proc,'_date_admitted')) >=0) |
                               (is.finite(get(paste0(proc,"_VTE_GP_date"))) & get(paste0(proc,'_VTE_GP_date')) - get(paste0(proc,'_date_admitted')) <= 90  & get(paste0(proc,'_VTE_GP_date')) - get(paste0(proc,'_date_admitted')) >=0)) &
                               (is.finite(get(paste0(proc,"_anticoagulation_prescriptions_date"))) & get(paste0(proc,'_anticoagulation_prescriptions_date')) - get(paste0(proc,'_date_admitted')) <= 90  & get(paste0(proc,'_anticoagulation_prescriptions_date')) - get(paste0(proc,'_date_admitted')) >=0),dig = 4)],
