...
```{r flowchart,out.width = "0.8\\linewidth", fig.align = "center",fig.cap = c("Flow chart of patients, procedures and outcomes included within censored follow up time")}
#load(here::here("output","flowchart.RData"))
knitr::include_graphics(here::here("output","flowchart.pdf"))
```
...
knitr::kable(cuminc.adjusted.VTE,col.names = paste0("Wave ",1:4),caption = caption = paste0("Cumulative incidence of 90 day post operative VTE risk by procedure type and COVID-19 infection, and stratified by COVID-19 wave."), row.names = T, digits = 4)
...
knitr::kable(cuminc.adjusted.mortality,col.names = paste0("Wave ",1:4),paste0("Cumulative incidence of 90 day post operative mortality risk by procedure type and COVID-19 infection, and stratified by COVID-19 wave."), row.names = T, digits = 4)
