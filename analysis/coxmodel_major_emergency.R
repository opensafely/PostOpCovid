...
procedures <- c('Abdominal','Orthopaedic','CardioThoracicVascular')
dt.tv<- dt.tv[Emergency== T & Major.op==T & Obstetrics == F]
...
modelsummary::modelsummary(post.op.VTE.model,estimate  = "{estimate} [{conf.low}, {conf.high}], (p = {p.value})", 
                           ...
                           conf_level = .95, exponentiate = TRUE, output = here::here("output","postopVTEmodel_major_emergency.html"))
modelsummary::modelsummary(post.op.VTE.model,estimate  = "{estimate} [{conf.low}, {conf.high}], (p = {p.value})", 
                           statistic = NULL, gof_omit = "Num.Obs.|n|nevent",
                           conf_level = .95, exponentiate = TRUE, output = here::here("output","postopVTEmodel_major_emergency.txt"))
...
new.data.postop.covid <- data.table::data.table('start' = rep(0,8*length(procedures)),
                                                ...
                                                'Abdominal' = c(rep(T,8),rep(F,16)),
                                                #    'Cardiac'=c(rep(F,8),rep(T,8),rep(F,32)),
                                                'Orthopaedic'=c(rep(F,8),rep(T,8),rep(F,8)),
                                                #   'Thoracic'=c(rep(F,32),rep(T,8),rep(F,8)),
                                                'CardioThoracicVascular'=c(rep(F,12),rep(T,8)),
...
save(post.op.VTE.model,cuminc.adjusted.VTE, file = here::here("output","postopVTE_major_emergency.RData"))
data.table::fwrite(cuminc.adjusted.VTE, file = here::here("output","postopVTE_major_emergency.csv"))
...
ggplot2::ggsave(plot = VTE.waves.plot, here::here('output','VTE_waves_major_emergency.png'),dpi = 'retina', width = 7, height = 5, units = 'in', device = 'png' )
...
save(post.op.VTE.model,cuminc.adjusted.VTE, file = here::here("output","postopVTE_major_emergency_unvac.RData"))
data.table::fwrite(cuminc.adjusted.VTE, file = here::here("output","postopVTE_major_emergency_unvac.csv"))
...
ggplot2::ggsave(plot = VTE.waves.plot, here::here('output','VTE_waves_major_emergency_unvac.png'),dpi = 'retina', width = 7, height = 5, units = 'in', device = 'png' )
...
save(post.op.VTE.model,cuminc.adjusted.VTE, file = here::here("output","recentcovid_postopVTE_major_emergency.RData"))
data.table::fwrite(cuminc.adjusted.VTE, file = here::here("output","recentcovid_postopVTE_major_emergency.csv"))
...
ggplot2::ggsave(plot = VTE.waves.plot, here::here('output','recentcovid_VTE_waves_major_emergency.png'),dpi = 'retina', width = 7, height = 5, units = 'in', device = 'png' )
...
save(post.op.VTE.model,cuminc.adjusted.VTE, file = here::here("output","recentcovid_postopVTE_major_emergency_unvac.RData"))
data.table::fwrite(cuminc.adjusted.VTE, file = here::here("output","recentcovid_postopVTE_major_emergency_unvac.csv"))
...
ggplot2::ggsave(plot = VTE.waves.plot, here::here('output','recentcovid_VTE_waves_major_emergency_unvac.png'),dpi = 'retina', width = 7, height = 5, units = 'in', device = 'png' )
