...
dt.tv<- dt.tv[Emergency== F & Major.op==T & Obstetrics == F]
...
modelsummary::modelsummary(post.op.VTE.model,estimate  = "{estimate} [{conf.low}, {conf.high}], (p = {p.value})", 
                           ...
                           conf_level = .95, exponentiate = TRUE, output = here::here("output","postopVTEmodel_major_elective.html"))
modelsummary::modelsummary(post.op.VTE.model,estimate  = "{estimate} [{conf.low}, {conf.high}], (p = {p.value})", 
                           statistic = NULL, gof_omit = "Num.Obs.|n|nevent",
                           conf_level = .95, exponentiate = TRUE, output = here::here("output","postopVTEmodel_major_elective.txt"))
...
save(post.op.VTE.model,cuminc.adjusted.VTE, file = here::here("output","postopVTE_major_elective.RData"))
data.table::fwrite(cuminc.adjusted.VTE, file = here::here("output","postopVTE_major_elective.csv"))
...
ggplot2::ggsave(plot = VTE.waves.plot, here::here('output','VTE_waves_major_elective.png'),dpi = 'retina', width = 7, height = 5, units = 'in', device = 'png' )
...
save(post.op.VTE.model,cuminc.adjusted.VTE, file = here::here("output","postopVTE_major_elective_unvac.RData"))
data.table::fwrite(cuminc.adjusted.VTE, file = here::here("output","postopVTE_major_elective_unvac.csv"))
...
ggplot2::ggsave(plot = VTE.waves.plot, here::here('output','VTE_waves_major_elective_unvac.png'),dpi = 'retina', width = 7, height = 5, units = 'in', device = 'png' )
...
save(post.op.VTE.model,cuminc.adjusted.VTE, file = here::here("output","recentcovid_postopVTE_major_elective.RData"))
data.table::fwrite(cuminc.adjusted.VTE, file = here::here("output","recentcovid_postopVTE_major_elective.csv"))
...
ggplot2::ggsave(plot = VTE.waves.plot, here::here('output','recentcovid_VTE_waves_major_elective.png'),dpi = 'retina', width = 7, height = 5, units = 'in', device = 'png' )
...
save(post.op.VTE.model,cuminc.adjusted.VTE, file = here::here("output","recentcovid_postopVTE_major_elective_unvac.RData"))
data.table::fwrite(cuminc.adjusted.VTE, file = here::here("output","recentcovid_postopVTE_major_elective_unvac.csv"))
...
ggplot2::ggsave(plot = VTE.waves.plot, here::here('output','recentcovid_VTE_waves_major_elective_unvac.png'),dpi = 'retina', width = 7, height = 5, units = 'in', device = 'png' )
