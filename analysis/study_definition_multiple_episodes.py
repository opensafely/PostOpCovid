...
def loop_over_OPCS_codelists(code_list_list):

    def with_these_procedures(codes):
        return {
            f"{codes}_date": (
    ...
    variables = {}
    for codes in code_list_list:
        variables.update(with_these_procedures(codes))
    return variables
...
#     #########################################
    ...
    **loop_over_OPCS_codelists([left_hemicolectomy_codes,right_hemicolectomy_codes,total_colectomy_codes,rectal_resection_codes]),
