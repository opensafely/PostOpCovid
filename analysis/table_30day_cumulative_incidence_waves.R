...
ggplot2::ggsave(plot = VTE_30dayincidence_procedure_waves_plot, here::here("output", "VTE_30dayincidence_procedure_waves_plot.png"), dpi = 'retina', width = 7, height = 5, units = "in", device = "png")
